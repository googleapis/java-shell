...
[google-cloud-java/java-shell](
https://github.com/googleapis/google-cloud-java/tree/main/java-shell).
This repository will be archived in the future.
Future releases will appear in the new repository (https://github.com/googleapis/google-cloud-java/releases).
The Maven artifact coordinates (`com.google.cloud:google-cloud-shell`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-shell:2.10.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-shell" % "2.10.0"
```
